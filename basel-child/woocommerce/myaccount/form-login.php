...
<?php endif; ?>
		...
		<p>Benvenuto nell'area riservata dedicata ai veterinari. Inserisci nome utente e password per accedere. Se non sei già registrato compila il modulo di registrazione tramite la sezione qui a lato.</p>
	...
	<?php if ( $tabs ): ?>
		<div class="col-2 col-register-text">
			...
			<?php if ( $login_text || $reg_text ): ?>
					...
					<h2>Registrazione</h2>
				 Registrati per accedere come veterinario cliccando il bottone qui sotto. La registrazione non è automatica ma verrà visionata dal nostro Staff ed approvata entro 2 giorni lavorativi. Contattaci per ulteriori informazioni.
				<br /><br />
			<?php endif ?>
