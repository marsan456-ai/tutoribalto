jQuery( document ).ready(function(){
    jQuery('#billing_country').change(function(){ if(jQuery(this).val()=='GB'){  
        ...
        jQuery('.ca_open').trigger('click');
      }else if(jQuery(this).val()=='IE'){
        jQuery('.ir_open').trigger('click');
      }else if(jQuery(this).val()=='NZ'){
        jQuery('.nz_open').trigger('click');
      }else if(jQuery(this).val()=='AU'){
        jQuery('.au_open').trigger('click');
      }else{
      jQuery("#cerror").html(''); 
      } });
